        ...
        <div className="flex h-screen flex-col md:flex-row">
          ...
          <aside className="hidden md:flex w-64 bg-dark-card border-r border-border-gray flex-col py-8 px-6">
            ...
            <nav className="flex flex-col gap-2 flex-1">
              <Link href="/" className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/5 text-text-secondary hover:text-text-primary transition-all">
          ...
          <div className="flex-1 flex flex-col min-w-0 min-h-0">
            ...
            <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-dark-card border-t border-border-gray h-16 flex items-center justify-around z-50">
              <Link href="/" className="flex flex-col items-center gap-1 text-text-secondary active:text-accent-pink">
